...
[![](https://jitpack.io/v/szendo/bubbles-for-android.svg)](https://jitpack.io/#szendo/bubbles-for-android)
...
```groovy
    ...
    dependencies {
	        compile 'com.github.szendo:bubbles-for-android:{insert-latest-version}'
	}   
```
